...
import Agents.MonteCarlo.MonteCarloAgent;
...
{	
	...
	public static void main(String[] args)
	{
		...
		// Choose pacman agent:
		// MonteCarloAgent, HeuristicAgent, MinimaxAgent, AlphaBetaAgent
		String agentName = "HeuristicAgent";

		// Choose ghosts agent:
		// RandomGhosts, StarterGhosts, AggressiveGhosts, Legacy2TheReckoning
		String ghostType = "AggressiveGhosts";

		// Do not change code below
		Executor exec=new Executor();
		Controller<MOVE> agent;
		switch (agentName) {
			case "MonteCarloAgent":
				agent = new MonteCarloAgent();
				break;
			case "HeuristicAgent":
    ...
    /**
     * For running multiple games without visuals. This is useful to get a good idea of how well a agent plays
     * against a chosen opponent: the random nature of the game means that performance can vary from game to game. 
     * Running many games and looking at the average score (and standard deviation/error) helps to get a better
     * idea of how well the agent is likely to do in the competition.
     *
     * @param pacManController The Pac-Man agent
     * @param ghostController The Ghosts agent
